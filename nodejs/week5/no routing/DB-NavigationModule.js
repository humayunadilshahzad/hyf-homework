...
class StudentBook {
    ...
    getStudentsList() {
        ...
        let x = this.students.map(student => {
    ...
    getStudentsFilterByClass(ClassId) {
        let classList= this.students.filter(student => student.classId === ClassId)
    ...
    addNewStudent(NewStudent) {
       // if(NewStudent.na  NewStudent.length<3 ) check for all fields are given or return ...null
